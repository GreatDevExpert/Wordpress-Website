...
*/
$baseUrl = 'http://vhp.itgnome.com/img/userfiles/';
...
*/
// $baseDir = resolveUrl($baseUrl);
$baseDir = '/home/vhp/public_html/app/webroot/img/userfiles/';
...
$config['plugin_imageresize']['microThumb'] = '60x60';
$config['plugin_imageresize']['smallThumb'] = '90x90';
$config['plugin_imageresize']['mediumThumb'] = '120x120';
$config['plugin_imageresize']['largeThumb'] = '180x180';
$config['plugin_imageresize']['xlargeThumb'] = '240x240';
